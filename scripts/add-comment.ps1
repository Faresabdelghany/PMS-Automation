...
$body = @{ todo_id = $TodoId; author = $Author; html = $Html } | ConvertTo-Json
$res = Invoke-RestMethod -Uri "https://uvqnrysmjpyupkhtnyfd.supabase.co/rest/v1/comments" -Method Post -Headers $h -Body $body
